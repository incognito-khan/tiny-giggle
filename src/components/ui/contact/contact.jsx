...
import { useMotionValue, useSpring, useTransform, AnimatePresence, motion, useAnimation, useInView, delay } from "framer-motion";
                    ...
                    >
                        ...
                        >
                            <p className="text-gray-600">
                                <span className="text-brand font-bold">Address:</span> Baby jounrel WQ 966 Munich Express 70
                            </p>
                            <p className="text-gray-600">Manhattan, Kansas 66506, USA</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-secondary mb-2">Customer Service :</h3>
                        ...
                        >
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-secondary mb-2">Careers :</h3>
                                <p className="text-gray-600">softexsolution.com</p>
                            </div>
                        </motion.div>

                        <img className="w-full" src="https://html.vecurosoft.com/toddly/demo/assets/img/elements/divider-contact.svg" alt="" />

                        {/* Social Media */}
                        <div>
                            <div className="flex items-center gap-4">
                                <span className="text-gray-800 font-bold text-sm">FOLLOW US :</span>

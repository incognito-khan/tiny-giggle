      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Blog Posts */}
            {blogPosts.map((post) => (
              <article key={post.id} onClick={() => router.push(`/blogs/${post.id}`)} className="bg-white rounded-2xl overflow-hidden">
                {/* Post Image */}
                ...
                <div className="py-6">
                  ...
                  {/* Excerpt */}
                  <p className="text-gray-800 leading-relaxed mb-6">{post.excerpt}</p>
                ...
                {/* Dotted Separator */}
                <div className="pb-6">
                  <img src="https://html.vecurosoft.com/toddly/demo/assets/img/elements/vs-blog-ele1.svg" alt="" />
                </div>
              </article>
            ))}

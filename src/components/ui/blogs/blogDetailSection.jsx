...
import { Search, ChevronRight, Calendar, User, Tag, Mail, Share2, ArrowLeft } from "lucide-react"
          ...
          <div className="lg:col-span-2">
            <article className=" rounded-2xl overflow-hidden">
              ...
              <div className="p-8">
                ...
                {/* Title */}
                <h1 className="text-3xl font-bold text-gray-800 mb-8 leading-tight">{post.title}</h1>

                {/* Article Content */}
                <div className="prose prose-lg max-w-none">
                  {/* First Paragraphs */}
                  {post.content.paragraphs.slice(0, 2).map((paragraph, index) => (
                  ...
                  {post.content.paragraphs.length > 2 && (
                    <p className="text-gray-600 leading-relaxed mb-8">{post.content.paragraphs[2]}</p>
                  )}

                  {/* Subheading */}
                  {post.content.subheading && (
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">{post.content.subheading}</h2>
                  )}

                  {/* More Paragraphs */}
                  {post.content.paragraphs.slice(3).map((paragraph, index) => (
                    <p key={index + 3} className="text-gray-600 leading-relaxed mb-8">
                      {paragraph}
                    </p>
                  ))}
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    consectetur adipisc ing elit dictum quam augue ac lacor eet ligero comodo consequatcoe ctetur
                    adipisc ing elit, sed do eiusmod tempor incididunt ut la bore et dolore magna aliqua. Lorem ipsum
                    dolorsit amet contetur adipisc ingelit, sed do eiusmod tempor incidunt.
                  </p>
                </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {post.tags.map((tag, index) => (
                        ...
                        >
                          {tag}
                          {index < post.tags.length - 1 && <span className="text-gray-400 ml-1">,</span>}
                        </span>
                      ))}
                    </div>
                  </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-brand flex-shrink-0">
                  <div
                    ...
                    style={{
                      backgroundImage: "url(https://html.vecurosoft.com/toddly/demo/assets/img/blog/comment-author-2.png)",
                    }}
                  ></div>
                </div>
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white mb-3">Alexra Dadder</h3>
                  <p className="text-white/90 leading-relaxed">
                    Consectetur Adipisc Ing Elits Dictum Quam Augue Ac Lacor Eet Liglero Comodo Consequatcoe Ctetur
                    Adipisc Ingelit, Sed Eiusmod Tempor Incididunt Ut La Bore Et Dolore Magna Aliqua.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-8">3 Comments</h3>

              <div className="space-y-6">
                {comments.map((comment) => (
                  <>
                    <div key={comment.id} className="border border-dashed border-gray-300 rounded-2xl p-6 mb-4">
            ...
            <div className="bg-[#F6F1E4] rounded-2xl p-8 border border-gray-300">
              <h3 className="text-3xl font-bold text-gray-800 mb-4">Leave a Comment</h3>
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <label htmlFor="save-details" className="text-gray-600 text-sm leading-relaxed">

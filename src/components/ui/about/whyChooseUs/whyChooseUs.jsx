                    ...
                    <div className="flex-1">
                        ...
                        <div className="mb-8">
                            <div className="relative w-[80px] h-[80px]">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center w-full h-full">
                                    <img className="w-full h-full" src="https://html.vecurosoft.com/toddly/demo/assets/img/why/why-choose-us-ele1.png" alt="" />
                                </div>
                            </div>
                        </div>
                        <div className="flex space-between w-full items-end">
                            <div className="mb-4 w-full">
                                ...
                                <motion.p className="text-[#8B7355] font-medium tracking-wider uppercase mb-2 title text-xl"
                                    variants={subVariants}
                                    initial="hidden"
                                    animate={subControls}
                                >

                                    {"Why Tiny Giggle Stands Out".split("").map((ch, i) => (
                                ...
                                >
                                    {"Delightful Moments Smartly Tracked".split("").map((ch, i) => (
                                    <motion.span key={i} variants={charVariant} aria-hidden="true">
                                        {ch}
                                    </motion.span>
                                ))}
                            ...
                            <div className="w-1/2">
                                <div className="p-6">
                                    <p className="text-gray-600 font-semibold text-base leading-relaxed border-l-2 border-brand pl-3">
                                        Empowering parents with intuitive tools to record every giggle, milestone, and memory—big or small.
                                    </p>
                                </div>
                            </div>
                    ...
                    {cardsData.map((card) => (
                        ...
                        >
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-[#2C3E50]">{card.title}</h2>
                            </div>

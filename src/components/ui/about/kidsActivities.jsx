...
export default function KidsActivities() {
  ...
  const xTurtle = useTransform(springX, v => v * 0.10);
  const yTurtle = useTransform(springY, v => v * 0.10);
  const xCharacter = useTransform(springX, v => v * 0.10);
  const yCharacter = useTransform(springY, v => v * 0.10);
  ...
  return (
    <div ref={ref} className="py-16 bg-gray-50 relative overflow-hidden bg-cover bg-center"
      onMouseMove={(e) => {
      ...
      style={{ backgroundImage: `url(https://html.vecurosoft.com/toddly/demo/assets/img/rooms/room-bg.png)` }}
    >
      ...
      <div className="absolute -bottom-8 right-8 z-10">
        <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/rooms/room-ele2.png" className="w-[86%]"
          alt=""
      ...
      <div className="absolute top-10 left-8 z-10">
        <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/rooms/room-ele1.png" className="w-[86%]"
          alt=""
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex gap-12 items-center mb-16">
          ...
          <div className="relative w-full">
            <div className="flex items-stretch gap-1  h-[230px] rounded-2xl" style={{ backgroundImage: `url(https://html.vecurosoft.com/toddly/demo/assets/img/rooms/room-video-bg.jpg)` }}>
              ...
              <motion.div className="bg-secondary rounded-2xl p-8 text-white flex-shrink-0 w-[210px] shadow-[0_0_0px_7px_#ffffff] border-2 border-dashed border-gray-400">
                <div className="text-center" ref={ref}>
                  ...
                  <p className="text-sm font-semibold my-6">Years Of Experience</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {activitiesData.map((activity) => (
            ...
            >
              {/* Icon */}
              <div className="mb-6">
                <activity.icon className="w-12 h-12 text-white mx-auto" strokeWidth={1.5} />
              </div>

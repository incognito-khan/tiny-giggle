...
import { useMotionValue, useSpring, useTransform, motion, useAnimation, useInView } from "framer-motion";
...
export default function PreschoolHero() {
  ...
  const xCloud = useTransform(springX, v => v * 0.10);
  const yCloud = useTransform(springY, v => v * 0.10);
  ...
  return (
    <div ref={ref}
      ...
      {/* bg img */}
      <div className="absolute w-full h-full -z-[3] inset-0 opacity-5 top-0 left-0 right-0 bottom-0 bg-cover bg-center"
        style={{ backgroundImage: `url(https://html.vecurosoft.com/toddly/demo/assets/img/video/video-bg-image.jpg)` }}
      ></div>
      {/* Decorative Airplane */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-white text-xl font-bold">+1 344 688 955</p>
            </div>
          </div>
        </div>
      </div>

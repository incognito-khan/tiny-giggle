...
export default function GradePrograms() {
  ...
  return (
    ...
    >
      {/* Main Orange Section */}
      <div className=" pt-[190px] pb-[170px] relative bg-cover bg-center h-[550px] w-full"
        style={{ backgroundImage: "url(https://html.vecurosoft.com/toddly/demo/assets/img/bg/program-bg.png)" }}
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 overflow-hidden">
          ...
          >
            <path d="M0 0C200 40 400 40 600 20C800 0 1000 30 1200 10V60H0V0Z" fill="#fef3e2" />
          </svg>
        </div>

        {/* Decorative Airplane- moveable */}
        <div className="absolute top-8 left-16">
          <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/pro/pro-ele-1.png"
            alt=""
        ...
        <div className="absolute top-8 right-16">
          <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/pro/pro-ele-2.png"
            alt=""
        ...
        <div className="absolute right-0 -bottom-20 z-50">
          <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/pro/pro-ele-3.png"
            alt=""
              ...
              >
                {gradeData.map((item) => (
                  <SwiperSlide key={item.id}>
                    <div className="bg-white rounded-full p-8 border-4 border-dashed border-orange-300 text-center shadow-lg">
                      {/* Grade Badge */}
                      <div className="mb-4">
                        <div
                      ...
                      {/* Grade Title */}
                      <h3 className="text-2xl font-bold text-gray-800 mb-2">{item.grade}</h3>

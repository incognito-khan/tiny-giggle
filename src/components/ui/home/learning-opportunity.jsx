...
export default function LearningOpportunity() {
  ...
  const xRocket = useTransform(springX, v => v * 0.10);
  const yRocket = useTransform(springY, v => v * 0.10);
  const xBalloon = useTransform(springX, v => v * 0.10);
  const yBalloon = useTransform(springY, v => v * 0.10);
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex gap-5 items-center">
          ...
          <div className="relative w-full">
            ...
            <div className="absolute top-0 left-0 z-10">
              <div className="w-[200px] h-[200px] rounded-2xl overflow-hidden shadow-lg">
                <div
                  ...
                  style={{
                    backgroundImage: "url(https://html.vecurosoft.com/toddly/demo/assets/img/about/vs-about-h1-1.jpg)",
                  }}
                ></div>
              </div>
            </div>
            ...
            {/* Experience Badge */}
            <div className="absolute text-black top-2 flex justify-center gap-3 items-center left-[250px] z-20">
              <div className="text-2xl font-bold shrink-0 bg-purple-600 text-white w-[60px] h-[60px] rounded-full shadow-lg flex justify-center items-center">21+</div>
            ...
            <div className="mt-[100px] ml-[150px] z-10">
              <div className="w-[400px] h-[400px] rounded-3xl overflow-hidden shadow-2xl">
                <div
                  className="w-full h-full bg-cover bg-center"
                  style={{
                    backgroundImage: "url(https://html.vecurosoft.com/toddly/demo/assets/img/about/vs-about-h1-2.jpg)",
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="absolute bottom-10 left-0">
              <div className="relative">
                ...
                <div className="absolute top-8 -left-10">
                  <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/about/vs-about-h1-ele-1.svg" 
                  alt=""
                ...
                <div className="absolute top-12 left-20">
                  <motion.img src="https://html.vecurosoft.com/toddly/demo/assets/img/about/vs-about-h1-ele-2.svg" 
                  alt=""

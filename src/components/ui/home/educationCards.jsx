...
import { ChevronLeft, ChevronRight, Backpack, Home, ArrowUpRight } from "lucide-react"
...
export default function EducationCards() {
    ...
    return (
        <div className="py-16 relative overflow-hidden"
            style={{ backgroundImage: `url(https://html.vecurosoft.com/toddly/demo/assets/img/service/service-bg.png)` }}
        >
            ...
            {/* Prev/Next Buttons */}
            <button onClick={() => swiperRef.current?.slidePrev()} className="absolute left-4 top-1/2 z-20 ...">
                <ChevronLeft />
            </button>
            <button onClick={() => swiperRef.current?.slideNext()} className="absolute right-4 top-1/2 z-20 ...">
                <ChevronRight />
            </button>
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                ${activeIndex === idx ? "bg-orange-500 scale-125" : "bg-gray-300 hover:bg-orange-300"}`}></button>
                    ))}
                </div>
            </div>
        </div>

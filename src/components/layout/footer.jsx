...
export default function Footer() {
  ...
  const exploreLinks = ["Blog", "About Us", "Contact Us", "Help center", "Become A Guide"]

  const membershipLinks = ["Join or Renew", "Membership", "Options", "Families"]
  ...
  return (
    <footer className="relative">
      ...
      <div className="bg-slate-800 text-white pt-16 pb-8 relative">
        ...
        <img src="https://html.vecurosoft.com/toddly/demo/assets/img/footer/footer-element-3.png" alt="" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <img src="/logo.png" alt="" className="h-20 bg-cover bg-center object-center" />
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold text-lg">+1 316-712-4886</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative top-[33px]">
                <img src="https://html.vecurosoft.com/toddly/demo/assets/img/footer/footer-element-1.png" alt="" />
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-white text-sm">
              Copyright © 2025 <span className="text-brabg-brand font-bold">TODDLY</span>. All Rights Reserved By{" "}

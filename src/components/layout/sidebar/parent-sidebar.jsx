                    ...
                    <div className="flex items-center w-full">
                      <div className="flex items-center w-full">
                        <div className="flex items-center pl-3">
                          <Icon
                            className={`w-5 h-5 mr-3 ${isOpen ? "text-white" : "text-pink-600"
                              }`}
                          />
                      ...
                      {section.items.map((it, idx) => {
                        ...
                        return (
                          <Button
                            key={idx}
                            variant="ghost"
                            className={`ml-3 w-[90%] justify-start text-sm rounded-full transition-all pl-10 text-gray-600 hover:bg-pink-50 cursor-pointer ${isActive

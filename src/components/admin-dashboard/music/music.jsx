...
export function Music() {
  ...
  const handleCategoryFilter = (categoryId) => {
    ...
    const filtered = musics.filter(music => music?.category?.id === categoryId);
  ...
  const handleEditMusic = async () => {
    ...
    if (editMusic.type === 'PAID' && (editMusic.price === 0 || editMusic.price === '' || editMusic.price === null)) {
      toast.error("Price should be greater than 0");
      return;
    }
          ...
          <div className="bg-card rounded-lg border border-border">
            ...
            <div className="p-6 border-b border-border">
              ...
              <div className="grid grid-cols-3 gap-4 items-center">
                <div>
                  <label className="block text-sm font-medium text-card-foreground mb-2">Music Title</label>
                  <Input placeholder="Enter music title" value={search} onChange={(e) => setSearch(e.target.value)} />
                </div>
                <div>
            ...
            {/* Table */}
            {musics?.length !== 0 && filteredMusics?.length !== 0 && !loading && (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditMusic({ ...editMusic, title: e.target.value })}
              />
            </div>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => setEditMusic({ ...editMusic, type: value })}
                className="w-full"
              >
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditMusic({ ...editMusic, price: e.target.value })}
                className="mt-1 rounded-full"
              />
            </div>

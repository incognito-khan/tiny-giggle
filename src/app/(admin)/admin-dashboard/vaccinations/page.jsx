...
const DUMMY_DATA = [
    {
        ...
        month: "At Birth (Month 1)",
        country: "Pakistan",
        note: "",
    },
    { id: "2", title: "OPV-1", administrationSite: "by-mouth", month: "Month 2", country: "Pakistan", note: "" },
    { id: "3", title: "Hepatitis B", administrationSite: "thigh", month: "Month 4", country: "USA", note: "" },
    { id: "4", title: "DTaP", administrationSite: "thigh", month: "Month 6", country: "USA", note: "" },
    { id: "5", title: "MMR", administrationSite: "right-upper-arm", month: "Month 12", country: "UAE", note: "" },
    { id: "6", title: "OPV-2", administrationSite: "by-mouth", month: "Month 18", country: "Pakistan", note: "" },
    {
        id: "7",
    ...
    return (
        <main className="mx-auto w-full p-6 space-y-6">
            ...
            <header className="bg-background border-b border-border flex items-center justify-between">
                <div>
                    <h1 className="text-balance text-2xl font-semibold tracking-tight">Vaccinations</h1>
                    <p className="text-muted-foreground">Manage Vaccinations.</p>
                </div>

...
const page = () => {
    return (
        <div className='min-h-screen bg-gray-50'>
            <Banner name="Why Choose Us" />
            <div className="bg-center bg-cover object-center" style={{backgroundImage: `url("https://html.vecurosoft.com/toddly/demo/assets/img/why/why-choose-us-bg.png)`}}>
                <WhyChooseUs />
                <Learning />
            </div>
            <AdmissionSection />
